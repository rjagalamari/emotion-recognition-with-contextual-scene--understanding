...
def main() -> None:
    ...
    embedding_root = PROJECT_ROOT / "Zip_files" / "facenetembeedings"
    output_dir = PROJECT_ROOT / "experiments" / "experiment1_2_face_token_attention"
    ...
    manifest.to_csv(output_dir / "manifest_experiment1_2.csv", index=False)
    ...
    for epoch in range(1, CONFIG["epochs"] + 1):
        ...
        train_bar = tqdm(loaders["train"], desc=f"experiment1_2 epoch {epoch}/{CONFIG['epochs']}", leave=False)
