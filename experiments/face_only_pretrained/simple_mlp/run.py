...
def main() -> None:
    ...
    output_dir = PROJECT_ROOT / "experiments" / "experiment1_sujal_style"
    ...
    manifest.to_csv(output_dir / "manifest_experiment1.csv", index=False)
    ...
    for epoch in range(1, CONFIG["epochs"] + 1):
        ...
        train_bar = tqdm(loaders["train"], desc=f"experiment1_sujal_style epoch {epoch}/{CONFIG['epochs']}", leave=False)
