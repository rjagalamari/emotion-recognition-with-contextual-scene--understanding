...
def main() -> None:
    ...
    output_dir = PROJECT_ROOT / "experiments" / "experiment2_scene_only_places365"
    ...
    manifest.to_csv(output_dir / "manifest_experiment2_places365.csv", index=False)
    ...
    for epoch in range(1, CONFIG["epochs"] + 1):
        ...
        train_bar = tqdm(loaders["train"], desc=f"experiment2_scene_only_places365 epoch {epoch}/{CONFIG['epochs']}", leave=False)
